...
namespace UnitTest
{
    ...
    public class CylDomain
    {
        ...
        {     // Arrange
            ...
            var m = Rhino.Geometry.Mesh.CreateFromBrep(box1.ToBrep(), mp);
            ...
            // Act
            OFCylDomain DOMCYL = new OFCylDomain(mm, null, bcond, 5, 50, 300, 80);

            Assert.IsTrue(DOMCYL.DomainMesh.Faces.Count == 320 && DOMCYL.DomainMesh.Vertices.Count == 322);
        }
    }
}