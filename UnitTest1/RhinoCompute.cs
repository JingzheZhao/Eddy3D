...
//        /// absolute tolerance used to insure the closed curve is planar
//        /// </param>
//        /// <returns>The AreaMassProperties for the given curve or null on failure.</returns>
//        /// <exception cref="System.ArgumentNullException">When closedPlanarCurve is null.</exception>
...
//        /// <summary>
//        /// Computes the Area properties for a collection of geometric objects. At present only
//        /// Breps, Surfaces, Meshes and Planar Closed Curves are supported.
//        /// </summary>
...
//        /// <summary>
//        /// Computes the AreaMassProperties for a collection of geometric objects. At present only
//        /// Breps, Surfaces, Meshes and Planar Closed Curves are supported.
//        /// </summary>
//        /// <param name="geometry">Objects to include in the area computation.</param>
//        /// <param name="area">true to calculate area.</param>
...
//        /// If the input curve has a g1-discontinuity with angle radian measure greater than
//        /// kinkTolerance at some point P, the list of beziers will also have a kink at P.
//        /// </param>
//        /// <returns>
...
//        /// The parameter direction (0 = U, 1 = V). The face's underlying surface must be closed in
//        /// this direction.
//        /// </param>
...
//        /// <returns>
//        /// A new Brep that has the same geoemtry as the face with a relocated seam if successful, or
//        /// null on failure.
//        /// </returns>
...
//        /// <summary>
//        /// Creates a brep representation of the sphere with two similar trimmed NURBS surfaces, and
//        /// no singularities.
//        /// </summary>
//        /// <param name="center">The center of the sphere.</param>
//        /// <param name="radius">The radius of the sphere.</param>
//        /// <param name="tolerance">
//        /// Used in computing 2d trimming curves. If &gt;= 0.0, then the max of ON_0.0001 * radius
//        /// and RhinoMath.ZeroTolerance will be used.
//        /// </param>
...
//        /// <summary>
//        /// Makes a curve blend between points on two surface edges. The blend will be tangent to the
//        /// surfaces and perpendicular to the edges.
//        /// </summary>
...
//        /// <param name="rev0">
//        /// If false, edge0 will be used in its natural direction. If true, edge0 will be used in the
//        /// reversed direction.
//        /// </param>
...
//        /// <param name="rev1">
//        /// If false, edge1 will be used in its natural direction. If true, edge1 will be used in the
//        /// reversed direction.
//        /// </param>
...
//        /// </param>
//        /// <param name="extend">
//        /// If true, then when one input surface is longer than the other, the chamfer surface is
//        /// extended to the input surface edges.
//        /// </param>
//        /// <param name="tolerance">
...
//        /// Rulings define lines across the surface that define the straight sections on the
//        /// developable surface, where rulings[i].X = parameter on first rail curve, and rulings[i].Y
//        /// = parameter on second rail curve. Note, rulings will be automatically adjusted to minimum twist.
//        /// </param>
//        /// <returns>The output Breps if successful, otherwise an empty array.</returns>
...
//        /// <param name="extend">
//        /// If true, then when one input surface is longer than the other, the fillet surface is
//        /// extended to the input surface edges.
//        /// </param>
//        /// <param name="tolerance">
//        /// The tolerance. In in doubt, the the document's model absolute tolerance.
...
//        /// </summary>
//        /// <param name="curves">
//        /// The curves to loft through. This function will not perform any curve sorting. You must
//        /// pass in curves in the order you want them lofted. This function will not adjust the
//        /// directions of open curves. Use Curve.DoDirectionsMatch and Curve.Reverse to adjust the
//        /// directions of open curves. This function will not adjust the seams of closed curves. Use
//        /// Curve.ChangeClosedCurveSeam to adjust the seam of closed curves.
//        /// </param>
//        /// <param name="start">
...
//        /// <summary>
//        /// Constructs one or more Breps by lofting through a set of curves. Input for the loft is
//        /// simplified by rebuilding to a specified number of control points.
//        /// </summary>
//        /// <param name="curves">
//        /// The curves to loft through. This function will not perform any curve sorting. You must
//        /// pass in curves in the order you want them lofted. This function will not adjust the
...
//        /// <summary>
//        /// Constructs one or more Breps by lofting through a set of curves. Input for the loft is
//        /// simplified by refitting to a specified tolerance.
//        /// </summary>
//        /// <param name="curves">
//        /// The curves to loft through. This function will not perform any curve sorting. You must
//        /// pass in curves in the order you want them lofted. This function will not adjust the
...
//        /// <returns>
//        /// A new brep if successful. The brep can be disjoint if bothSides is true and createSolid
//        /// is false, or if createSolid is true and connecting the offsets with side surfaces fails.
...
//        /// <summary>
//        /// Sweep1 function tht fits a surface through a profile curve that define the surface
...
//        /// <remarks>
//        /// If you are not producing the sweep results that you are after, then use the SweepOneRail
//        /// class with options to generate the swept geometry.
//        /// </remarks>
...
//        /// <summary>
//        /// Makes a 2 rail sweep. Like CreateFromSweep but the result is split where parameterization
//        /// along a rail changes abruptly
//        /// </summary>
//        /// <param name="rail1">Rail to sweep shapes along</param>
//        /// <param name="rail2">Rail to sweep shapes along</param>
//        /// <param name="shapes">Shape curves</param>
...
//        /// <summary>
//        /// Sweep1 function tht fits a surface through a profile curve that define the surface
//        /// cross-sections and one curve that defines a surface edge. The Segmented version breaks
//        /// the rail at curvature kinks and sweeps each piece separately, then put the results
//        /// together into a Brep.
//        /// </summary>
//        /// <param name="rail">Rail to sweep shapes along</param>
//        /// <param name="shape">Shape curve</param>
//        /// <param name="closed">Only matters if shape is closed</param>
...
//        /// <summary>
//        /// Sweep1 function tht fits a surface through a series of profile curves that define the
//        /// surface cross-sections and one curve that defines a surface edge. The Segmented version
//        /// breaks the rail at curvature kinks and sweeps each piece separately, then put the results
//        /// together into a Brep.
//        /// </summary>
//        /// <param name="rail">Rail to sweep shapes along</param>
//        /// <param name="shapes">Shape curves</param>
...
//        /// <param name="distance">
//        /// The distance to offset. This is a signed distance value with respect to face normals and
//        /// flipped faces.
//        /// </param>
//        /// <param name="solid">
//        /// If true, then the function makes a closed solid from the input and offset surfaces by
//        /// lofting a ruled surface between all of the matching edges.
//        /// </param>
//        /// <param name="extend">
//        /// If true, then the function maintains the sharp corners when the original surfaces have
//        /// sharps corner. If False, then the function creates fillets at sharp corners in the
//        /// original surfaces.
//        /// </param>
...
//        /// be returned. Otherwise, the array will contain the offset surfaces, outBlends will
//        /// contain the set of blends used to fill in gaps (if extend is false), and outWalls will
//        /// contain the set of wall surfaces that was supposed to join the offset to the original (if
//        /// solid is true).
//        /// </returns>
...
//        /// </summary>
//        /// <param name="geometry">
//        /// Combination of Curves, BrepTrims, Points, PointClouds or Meshes. Curves and trims are
//        /// sampled to get points. Trims are sampled for points and normals.
//        /// </param>
...
//        /// </param>
//        /// <returns>Brep fit through input on success, or null on error.</returns>
...
//        /// Constructs a brep patch.
//        /// <para>
//        /// This is the simple version of fit that uses a plane with u x v spans. It makes a plane by
//        /// fitting to the points from the input geometry to use as the starting surface. The surface
//        /// has the specified u and v span count.
//        /// </para>
//        /// </summary>
//        /// <param name="geometry">
//        /// A combination of <see cref="Curve">curves</see>, brep trims, <see
//        /// cref="Point">points</see>, <see cref="PointCloud">point clouds</see> or <see
//        /// cref="Mesh">meshes</see>. Curves and trims are sampled to get points. Trims are sampled
//        /// for points and normals.
//        /// </param>
...
//        /// Tolerance used by input analysis functions for loop finding, trimming, etc.
//        /// </param>
//        /// <returns>A brep fit through input on success, or null on error.</returns>
...
//        /// If True, Local (pipe radius stays constant at the ends and changes more rapidly in the
//        /// middle) is applied. If False, Global (radius is linearly blended from one end to the
//        /// other, creating pipes that taper from one radius to the other) is applied
//        /// </param>
//        /// <param name="cap">end cap mode</param>
//        /// <param name="fitRail">
//        /// If the curve is a polycurve of lines and arcs, the curve is fit and a single surface is
//        /// created; otherwise the result is a polysurface with joined surfaces created from the
//        /// polycurve segments.
//        /// </param>
//        /// <param name="absoluteTolerance">
//        /// The sweeping and fitting tolerance. If you are unsure what to use, then use the
//        /// document's absolute tolerance
//        /// </param>
//        /// <param name="angleToleranceRadians">
//        /// The angle tolerance. If you are unsure what to use, then either use the document's angle
...
//        /// <summary>
//        /// Creates a hollowed out shell from a solid Brep. Function only operates on simple, solid,
//        /// manifold Breps.
//        /// </summary>
...
//        /// </param>
//        /// <param name="distance">
//        /// The distance, or thickness, for the shell. This is a signed distance value with respect
//        /// to face normals and flipped faces.
//        /// </param>
//        /// <param name="tolerance">
...
//        /// </param>
//        /// <param name="tolerance">
//        /// The trim and join tolerance. If set to RhinoMath.UnsetValue, Rhino's global absolute
//        /// tolerance is used.
//        /// </param>
...
//        /// <summary>
//        /// Constructs a Brep using the trimming information of a brep face and a surface. Surface
//        /// must be roughly the same shape and in the same location as the trimming brep face.
//        /// </summary>
...
//        /// <summary>
//        /// Compute the Area of the Brep. If you want proper Area data with moments and error
...
//        /// <summary>
//        /// Compute the Volume of the Brep. If you want proper Volume data with moments and error
//        /// information, use the VolumeMassProperties class.
//        /// </summary>
...
//        /// <summary>
//        /// Determines if point is inside Brep. This question only makes sense when the brep is a
//        /// closed manifold. This function does not not check for closed or manifold, so result is
//        /// not valid in those cases. Intersects a line through point with brep, finds the
//        /// intersection point Q closest to point, and looks at face normal at Q. If the point Q is
//        /// on an edge or the intersection is not transverse at Q, then another line is used.
//        /// </summary>
//        /// <param name="point">3d point to test.</param>
//        /// <param name="tolerance">
//        /// 3d distance tolerance used for intersection and determining strict inclusion. A good
//        /// default is RhinoMath.SqrtEpsilon.
//        /// </param>
//        /// <param name="strictlyIn">
//        /// if true, point is in if inside brep by at least tolerance. if false, point is in if truly
//        /// in or within tolerance of boundary.
//        /// </param>
//        /// <returns>true if point is in, false if not.</returns>
...
//        /// <remarks>
//        /// if no edges overlap, this brep is unchanged. otherBrep is copied if it is merged with
//        /// this, and otherBrep is always unchanged Use this to join a list of breps in a series.
//        /// When joining multiple breps in series, compact should be set to false. Call compact on
//        /// the last Join.
//        /// </remarks>
...
//        /// <summary>
//        /// Joins the breps in the input array at any overlapping edges to form as few as possible
//        /// resulting breps. There may be more than one brep in the result array.
//        /// </summary>
...
//        /// <param name="joinTolerance">The join tolerance.</param>
//        /// <param name="compact">
//        /// If joining more than one edge pair and want the edge indices of subsequent pairs to
//        /// remain valid, set to false. But then call Brep.Compact() on the final result.
//        /// </param>
...
//        /// </summary>
//        /// <remarks>Don't call this function unless you know exactly what you are doing.</remarks>
...
//        /// <summary>
//        /// Combines two or more breps into one. A merge is like a boolean union that keeps the
//        /// inside pieces. This function creates non-manifold Breps which in general are unusual in
//        /// Rhino. You may want to consider using JoinBreps or CreateBooleanUnion functions instead.
//        /// </summary>
...
//        /// </summary>
//        /// <param name="tolerance">
//        /// Tolerance for determining when edges are adjacent. When in doubt, use the document's
...
//        /// Angle tolerance, in radians, for determining when faces are parallel. When in doubt, use
//        /// the document's ModelAngleToleranceRadians property.
//        /// </param>
//        /// <returns>true if faces were merged, false if no faces were merged.</returns>
...
//        /// </param>
//        /// <param name="angleToleranceRadians">
//        /// Edge must be within this angle tolerance in order for contiguous edges to be combined
//        /// into a single edge.
//        /// </param>
...
//        /// <summary>
//        /// Merges two surfaces into one surface at untrimmed edges. Both surfaces must be untrimmed
//        /// and share an edge.
//        /// </summary>
...
//        /// </param>
//        /// <param name="smooth">
//        /// The surface will be smooth. This makes the surface behave better for control point
//        /// editing, but may alter the shape of both surfaces.
//        /// </param>
//        /// <returns>The merged Brep if successful, null if not successful.</returns>
...
//        /// No support is available for this function.
//        /// <para>
//        /// Expert user function used by MakeValidForV2 to convert trim curves from one surface to
//        /// its NURBS form. After calling this function, you need to change the surface of the face
//        /// to a NurbsSurface.
//        /// </para>
//        /// </summary>
//        /// <param name="face">
...
//        /// <summary>
//        /// Fills in missing or fixes incorrect component information from a Brep. Useful when
//        /// reading Brep information from other file formats that do not provide as complete of a
//        /// Brep definition as requried by Rhino.
//        /// </summary>
//        /// <param name="tolerance">
...
//        /// Set to true if the split failed at intersectionTolerance but succeeded when the tolerance
//        /// was increased to twice intersectionTolerance.
//        /// </param>
//        /// <returns>A new array of Breps. This array can be empty.</returns>
...
//        /// <returns>A new array of Breps. This array can be empty.</returns>
//        /// <remarks>
//        /// A Curve in cutters is extruded to produce a surface to use as a cutter. The extrusion
//        /// direction is choosen, as in the Rhino Split command, based on the properties of the
//        /// active view. In particular the construction plane Normal and whether the active view is a
//        /// plan view, a parallel projection with construction plane normal as the view direction. If
//        /// planView is false and the curve is planar then the curve is extruded perpendicular to the
//        /// curve, otherwise the curve is extruded in the normal direction.
//        /// </remarks>
...
//        /// <param name="tolerance">
//        /// The desired fitting tolerance to use when bending faces that share edges with both fixed
//        /// and transformed components.
//        /// </param>
//        /// <param name="timeLimit">
//        /// If the deformation is extreme, it can take a long time to calculate the result. If
//        /// time_limit &gt; 0, then the value specifies the maximum amount of time in seconds you
//        /// want to spend before giving up.
//        /// </param>
...
//        /// <summary>
//        /// Trims a brep with an oriented cutter. The parts of the brep that lie inside (opposite the
//        /// normal) of the cutter are retained while the parts to the outside (in the direction of
//        /// the normal) are discarded. If the Cutter is closed, then a connected component of the
//        /// Brep that does not intersect the cutter is kept if and only if it is contained in the
//        /// inside of cutter. That is the region bounded by cutter opposite from the normal of
//        /// cutter, If cutter is not closed all these components are kept.
//        /// </summary>
...
//        /// <summary>
//        /// Trims a Brep with an oriented cutter. The parts of Brep that lie inside (opposite the
//        /// normal) of the cutter are retained while the parts to the outside ( in the direction of
//        /// the normal ) are discarded. A connected component of Brep that does not intersect the
//        /// cutter is kept if and only if it is contained in the inside of Cutter. That is the region
//        /// bounded by cutter opposite from the normal of cutter, or in the case of a Plane cutter
...
//        /// <remarks>
//        /// If the face had a surface and new surface has a different shape, then you probably want
//        /// to call something like RebuildEdges() to move the 3d edge curves so they will lie on the
//        /// new surface. This doesn't delete the old surface; call Brep.CullUnusedSurfaces() or
//        /// Brep.Compact() to remove unused surfaces.
//        /// </remarks>
...
//        /// <param name="tolerance">
//        /// Tolerance for pulling operation. Only points that are closer than tolerance will be
//        /// pulled to the face.
//        /// </param>
...
//        /// </param>
//        /// <param name="rebuildVertices">if true, vertex locations are updated to lie on the surface.</param>
//        /// <returns>true on success.</returns>
...
//        /// <summary>
//        /// Similar to IsoCurve function, except this function pays attention to trims on faces and
...
//        /// 0: horizontal, 1: vertical In the other Surface functions that take a "direction"
//        /// argument, "direction" indicates if "constantParameter" is a "u" or "v" parameter.
//        /// </remarks>
...
//        /// (intervals[i][0],iso_constant) and (intervals[i][1],iso_constant). If direction = 1, the
//        /// parameter space iso interval connects the 2d points (iso_constant,intervals[i][0]) and (iso_constant,intervals[i][1]).
//        /// </returns>
...
//        /// maximumDistance parameter is &gt; 0, then only points whose distance to the given point
//        /// is &lt;= maximumDistance will be returned. Using a positive value of maximumDistance can
//        /// substantially speed up the search.
//        /// </summary>
...
//        /// <summary>
//        /// Finds the parameter of the point on a curve that is closest to testPoint. If the
//        /// maximumDistance parameter is &gt; 0, then only points whose distance to the given point
//        /// is &lt;= maximumDistance will be returned. Using a positive value of maximumDistance can
//        /// substantially speed up the search.
//        /// </summary>
...
//        /// <summary>
//        /// Computes the relationship between a point and a closed curve region. This curve must be
//        /// closed or the return value will be Unset. Both curve and point are projected to the World
//        /// XY plane.
//        /// </summary>
...
//        /// <summary>
//        /// Computes the relationship between a point and a closed curve region. This curve must be
//        /// closed or the return value will be Unset.
//        /// </summary>
//        /// <param name="testPoint">Point to test.</param>
...
//        /// <summary>
//        /// Creates a polycurve consisting of two tangent arc segments that connect two points and
//        /// two directions.
//        /// </summary>
...
//        /// The ratio of the control polygon lengths of the two arcs. Note, a value of 1.0 means the
//        /// control polygon lengths for both arcs will be the same.
//        /// </param>
...
//        /// <summary>
//        /// Makes a curve blend between 2 curves at the parameters specified with the directions and
//        /// continuities specified
//        /// </summary>
//        /// <param name="curve0">First curve to blend from</param>
//        /// <param name="t0">Parameter on first curve for blend endpoint</param>
//        /// <param name="reverse0">
//        /// If false, the blend will go in the natural direction of the curve. If true, the blend
//        /// will go in the opposite direction to the curve
//        /// </param>
//        /// <param name="continuity0">Continuity for the blend at the start</param>
...
//        /// <summary>
//        /// Calculates the boolean difference between a closed planar curve, and a list of closed
//        /// planar curves. Note, curves must be co-planar.
//        /// </summary>
//        /// <param name="curveA">The first closed, planar curve.</param>
...
//        /// <param name="trim">Trim copies of the input curves to the output fillet curve.</param>
//        /// <param name="arcExtension">
//        /// Applies when arcs are filleted but need to be extended to meet the fillet curve or
//        /// chamfer line. If true, then the arc is extended maintaining its validity. If false, then
//        /// the arc is extended with a line segment, which is joined to the arc converting it to a polycurve.
//        /// </param>
//        /// <param name="tolerance">The tolerance, generally the document's absolute tolerance.</param>
//        /// <param name="angleTolerance"></param>
//        /// <returns>
//        /// The results of the fillet operation. The number of output curves depends on the input
//        /// curves and the values of the parameters that were used during the fillet operation. In
//        /// most cases, the output array will contain either one or three curves, although two curves
//        /// can be returned if the radius is zero and join = false. For example, if both join and
//        /// trim = true, then the output curve will be a polycurve containing the fillet curve joined
//        /// with trimmed copies of the input curves. If join = false and trim = true, then three
//        /// curves, the fillet curve and trimmed copies of the input curves, will be returned. If
//        /// both join and trim = false, then just the fillet curve is returned.
//        /// </returns>
//        /// <example>
...
//        /// <summary>
//        /// Interpolates a sequence of points. Used by InterpCurve Command This routine works best
//        /// when degree=3.
//        /// </summary>
//        /// <param name="degree">The degree of the curve &gt;=1. Degree must be odd.</param>
//        /// <param name="points">Points to interpolate (Count must be &gt;= 2)</param>
...
//        /// <param name="degree">The degree of the curve &gt;=1. Degree must be odd.</param>
//        /// <param name="points">
//        /// Points to interpolate. For periodic curves if the final point is a duplicate of the
//        /// initial point it is ignored. (Count must be &gt;=2)
//        /// </param>
//        /// <param name="knots">Knot-style to use and specifies if the curve should be periodic.</param>
//        /// <returns>interpolated curve on success. null on failure.</returns>
...
//        /// <param name="angleToleranceRadians">
//        /// The angle tolerance, in radians, used to match kinks between curves. If you are unsure
//        /// how to set this parameter, then either use the document's angle tolerance
//        /// RhinoDoc.AngleToleranceRadians, or the default value (RhinoMath.UnsetValue)
//        /// </param>
...
//        /// If false, control point locations are not changed or changed minimally (only one point
//        /// may move) and only the knot vector is altered.
//        /// </param>
//        /// <returns>The resulting curve if successful, null otherwise.</returns>
...
//        /// <param name="length">
//        /// The distance along the curve from the editing point over which the strength of the
//        /// editing falls off smoothly.
//        /// </param>
...
//        /// <summary>
//        /// Creates outline curves created from a text string. The functionality is similar to what
//        /// you find in Rhino's TextObject command or TextEntity.Explode() in RhinoCommon.
//        /// </summary>
...
//        /// The font style. The font style can be any number of the following: 0 - Normal, 1 - Bold,
//        /// 2 - Italic
//        /// </param>
//        /// <param name="closeLoops">
//        /// Set this value to True when dealing with normal fonts and when you expect closed loops.
//        /// You may want to set this to False when specifying a single-stroke font where you don't
//        /// want closed loops.
//        /// </param>
...
//        /// curves for finding tween curves. That means the first control point of first curve is
//        /// matched to first control point of the second curve and so on. There is no matching of
//        /// curves direction. Caller must match input curves direction before calling the function.
//        /// </summary>
...
//        /// <summary>
//        /// Creates curves between two open or closed input curves. Make the structure of input
//        /// curves compatible if needed. Refits the input curves to have the same structure. The
//        /// resulting curves are usually more complex than input unless input curves are compatible
//        /// and no refit is needed. There is no matching of curves direction. Caller must match input
...
//        /// curves compatible. This is how the algorithm workd: Divides the two curves into an equal
//        /// number of points, finds the midpoint between the corresponding points on the curves and
//        /// interpolates the tween curve through those points. There is no matching of curves
...
//        /// </param>
//        /// <param name="includeEnds">
//        /// If true, then the point at the start of the first division segment is returned.
//        /// </param>
//        /// <returns>List of curve parameters at the division points on success, null on failure.</returns>
...
//        /// </param>
//        /// <param name="points">
//        /// A list of division points. If the function returns successfully, this point-array will be
//        /// filled in.
//        /// </param>
...
//        /// <returns>
//        /// true if both curves more or less point in the same direction, false if they point in the
//        /// opposite directions.
//        /// </returns>
...
//        /// <summary>
//        /// Polylines will be exploded into line segments. ExplodeCurves will return the curves in
//        /// topological order.
//        /// </summary>
//        /// <returns>An array of all the segments that make up this curve.</returns>
...
//        /// <summary>
//        /// Where possible, analytically extends curve to include the given domain. This will not
//        /// work on closed curves. The original curve will be identical to the restriction of the
//        /// resulting curve to the original curve domain.
//        /// </summary>
//        /// <param name="t0">
//        /// Start of extension domain, if the start is not inside the Domain of this curve, an
//        /// attempt will be made to extend the curve.
//        /// </param>
//        /// <param name="t1">
//        /// End of extension domain, if the end is not inside the Domain of this curve, an attempt
//        /// will be made to extend the curve.
//        /// </param>
...
//        /// <summary>
//        /// Returns the parameter values of all local extrema. Parameter values are in increasing
//        /// order so consecutive extrema define an interval on which each component of the curve is
//        /// monotone. Note, non-periodic curves always return the end points.
//        /// </summary>
...
//        /// <summary>
//        /// Fairs a curve object. Fair works best on degree 3 (cubic) curves. Attempts to remove
//        /// large curvature variations while limiting the geometry changes to be no more than the
//        /// specified tolerance.
//        /// </summary>
//        /// <param name="distanceTolerance">
...
//        /// The fitting tolerance. If fitTolerance is RhinoMath.UnsetValue or &lt;=0.0, the document
...
//        /// <para>
//        /// If angleTolerance is RhinoMath.UnsetValue or &lt;0.0, the document angle tolerance is
//        /// used for the kink smoothing
//        /// </para>
//        /// </param>
...
//        /// Desired fractional precision. fabs(("exact" length from start to t) -
...
//        /// <summary>
//        /// Gets a collection of perpendicular frames along the curve. Perpendicular frames are also
//        /// known as 'Zero-twisting frames' and they minimize rotation from one frame to the next.
//        /// </summary>
//        /// <param name="parameters">
//        /// A collection of <i>strictly increasing</i> curve parameters to place perpendicular frames on.
//        /// </param>
...
//        /// <para>
//        /// If false, all start and endpoints will be compared and copies of input curves may be
//        /// reversed in output.
//        /// </para>
//        /// </param>
//        /// <returns>An array of joint curves. This array can be empty.</returns>
...
//        /// <summary>
//        /// Find parameter of the point on a curve that is locally closest to the testPoint. The
//        /// search for a local close point starts at a seed parameter.
//        /// </summary>
...
//        /// <summary>
//        /// Gets the parameter along the curve which coincides with a given length along the curve. A
//        /// fractional tolerance of 1e-8 is used in this version of the function.
//        /// </summary>
//        /// <param name="segmentLength">
...
//        /// </param>
//        /// <param name="subdomain">
//        /// The calculation is performed on the specified sub-domain of the curve rather than the
//        /// whole curve.
//        /// </param>
//        /// <returns>true on success, false on failure.</returns>
...
//        /// follows: Linear curves polylinear curves with 2 segments, Nurbs with 3 or less control
//        /// points cannot be made closed. Also, if tolerance &gt; 0 and the gap between start and end
//        /// is larger than tolerance, curve cannot be made closed. Adjust the curve's endpoint to
//        /// match its start point.
//        /// </summary>
//        /// <param name="tolerance">
...
//        /// <param name="adjustStartCurveB">which end of the 2nd curve to adjust true==start, false==end.</param>
//        /// <returns>true on success.</returns>
...
//        /// start of the curve. A fractional tolerance of 1e-8 is used in this version of the function.
//        /// </summary>
//        /// <param name="s">
//        /// Normalized arc length parameter. E.g., 0 = start of curve, 1/2 = midpoint of curve, 1 =
//        /// end of curve.
//        /// </param>
//        /// <param name="t">
...
//        /// </summary>
//        /// <param name="s">
//        /// Array of normalized arc length parameters. E.g., 0 = start of curve, 1/2 = midpoint of
//        /// curve, 1 = end of curve.
//        /// </param>
//        /// <param name="absoluteTolerance">
//        /// If absoluteTolerance &gt; 0, then the difference between (s[i+1]-s[i])*curve_length and
//        /// the length of the curve segment from t[i] to t[i+1] will be &lt;= absoluteTolerance.
//        /// </param>
//        /// <returns>
//        /// If successful, array of curve parameters such that the length of the curve from its start
//        /// to t[i] is s[i]*curve_length. Null on failure.
//        /// </returns>
...
//        /// </param>
//        /// <param name="fractionalTolerance">
//        /// Desired fractional precision for each segment. fabs("true" length - actual
...
//        /// </param>
//        /// <param name="subdomain">
//        /// The calculation is performed on the specified sub-domain of the curve. A 0.0 s value
//        /// corresponds to subdomain-&gt;Min() and a 1.0 s value corresponds to subdomain-&gt;Max().
//        /// </param>
//        /// <returns>
//        /// If successful, array of curve parameters such that the length of the curve from its start
//        /// to t[i] is s[i]*curve_length. Null on failure.
...
//        /// <summary>
//        /// Offsets this curve. If you have a nice offset, then there will be one entry in the array.
//        /// If the original curve had kinks or the offset curve had self intersections, you will get
//        /// multiple segments in the offset_curves[] array.
//        /// </summary>
...
//        /// <summary>
//        /// Finds a curve by offsetting an existing curve normal to a surface. The caller is
...
//        /// <returns>
//        /// Offset curve at distance height from the surface. The offset curve is interpolated
//        /// through a small number of points so if the surface is irregular or complicated, the
...
//        /// If face, curveParameters or offsetDistances are null.
//        /// </exception>
...
//        /// <returns>Offset curves on success, or null on failure.</returns>
//        /// <exception cref="ArgumentNullException">
//        /// If surface, curveParameters or offsetDistances are null.
//        /// </exception>
...
//        /// <summary>
//        /// Return a 3d frame at a parameter. This is slightly different than FrameAt in that the
//        /// frame is computed in a way so there is minimal rotation from one frame to the next.
//        /// </summary>
...
//        /// otherwise, if the regions have a containment relationship, discovers which curve encloses
//        /// the other.
//        /// </summary>
//        /// <param name="curveA">A first curve.</param>
//        /// <param name="curveB">A second curve.</param>
...
//        /// <returns>A value indicating the relationship between the first and the second curve.</returns>
...
//        /// <summary>
//        /// Gets a point at a certain length along the curve. The length must be non-negative and
//        /// less than or equal to the length of the curve. Lengths will not be wrapped when the curve
...
//        /// <summary>
//        /// Gets a point at a certain normalized length along the curve. The length must be between
//        /// or including 0.0 and 1.0, where 0.0 equals the start of the curve and 1.0 equals the end
//        /// of the curve.
//        /// </summary>
//        /// <param name="length">
...
//        /// </param>
//        /// <returns>
//        /// Point on the curve at the specified normalized length from the start point or
...
//        /// each point on the curve. Then it "connects the points" so that you have a polyline on the mesh.
//        /// </summary>
...
//        /// <summary>
//        /// Looks for segments that are shorter than tolerance that can be removed. Does not change
//        /// the domain, but it will change the relative parameterization.
//        /// </summary>
...
//        /// <summary>
//        /// Offsets a closed curve in the following way: pProject the curve to a plane with given
//        /// normal. Then, loose Offset the projection by distance + blend_radius and trim off
//        /// self-intersection. THen, Offset the remaining curve back in the opposite direction by
//        /// blend_radius, filling gaps with blends. Finally, use the elevations of the input curve to
//        /// get the correct elevations of the result.
//        /// </summary>
...
//        /// A point that indicates the direction of the offset. If the offset is inward, the point's
//        /// projection to the plane should be well within the curve. It will be used to decide which
//        /// part of the offset to keep if there are self-intersections.
//        /// </param>
//        /// <param name="normal">
...
//        /// <para>1. All the PolyCurve segments are LineCurve, PolylineCurve, ArcCurve, or NurbsCurve.</para>
//        /// <para>2. The Nurbs Curves segments do not have fully multiple interior knots.</para>
//        /// <para>3. Rational Nurbs curves do not have constant weights.</para>
//        /// <para>
//        /// 4. Any segment for which IsLinear() or IsArc() is true is a Line, Polyline segment, or an Arc.
//        /// </para>
//        /// <para>5. Adjacent Colinear or Cocircular segments are combined.</para>
//        /// <para>
//        /// 6. Segments that meet with G1-continuity have there ends tuned up so that they meet with
...
//        /// </summary>
//        /// <param name="end">
//        /// If CurveEnd.Start the function simplifies the last two start side segments, otherwise if
//        /// CurveEnd.End the last two end side segments are simplified.
//        /// </param>
//        /// <param name="options">Simplification options.</param>
//        /// <param name="distanceTolerance">A distance tolerance for the simplification.</param>
//        /// <param name="angleToleranceRadians">An angle tolerance for the simplification.</param>
...
//        /// <summary>
//        /// Converts a curve into polycurve consisting of arc segments. Sections of the input curves
//        /// that are nearly straight are converted to straight-line segments.
//        /// </summary>
//        /// <param name="tolerance">
//        /// The tolerance. This is the maximum deviation from arc midpoints to the curve. When in
//        /// doubt, use the document's model space absolute tolerance.
//        /// </param>
//        /// <param name="angleTolerance">
...
//        /// If mainSegmentCount &gt; 0, then subSegmentCount must be &gt;= 1. In this case the nurb
//        /// will be broken into mainSegmentCount equally spaced chords. If needed, each of these
//        /// chords can be split into as many subSegmentCount sub-parts if the subdivision is
//        /// necessary for the mesh to meet the other meshing constraints. In particular, if
//        /// subSegmentCount = 0, then the curve is broken into mainSegmentCount pieces and no further
...
//        /// If maxAspectRatio &lt; 1.0, the parameter is ignored. If 1 &lt;= maxAspectRatio &lt;
//        /// sqrt(2), it is treated as if maxAspectRatio = sqrt(2). This parameter controls the
//        /// maximum permitted value of (length of longest chord) / (length of shortest chord).
//        /// </param>
//        /// <param name="tolerance">
//        /// If tolerance = 0, the parameter is ignored. This parameter controls the maximum permitted
//        /// value of the distance from the curve to the polyline.
//        /// </param>
//        /// <param name="minEdgeLength">The minimum permitted edge length.</param>
//        /// <param name="maxEdgeLength">
//        /// If maxEdgeLength = 0, the parameter is ignored. This parameter controls the maximum
//        /// permitted edge length.
//        /// </param>
//        /// <param name="keepStartPoint">
//        /// If true the starting point of the curve is added to the polyline. If false the starting
//        /// point of the curve is not added to the polyline.
//        /// </param>
...
//        /// </summary>
//        /// <param name="tolerance">
//        /// The tolerance. This is the maximum deviation from line midpoints to the curve. When in
//        /// doubt, use the document's model space absolute tolerance.
//        /// </param>
//        /// <param name="angleTolerance">
//        /// The angle tolerance in radians. This is the maximum deviation of the line directions.
//        /// When in doubt, use the document's model space angle tolerance.
//        /// </param>
//        /// <param name="minimumLength">The minimum segment length.</param>
//        /// <param name="maximumLength">The maximum segment length.</param>
//        /// <returns>PolyCurve on success, null on error.</returns>
...
//        /// ClosestPoint function except this returns a MeshPoint class which includes extra
//        /// information beyond just the location of the closest point.
//        /// </summary>
//        /// <param name="testPoint">The source of the search.</param>
//        /// <param name="maximumDistance">
//        /// Optional upper bound on the distance from test point to the mesh. If you are only
//        /// interested in finding a point Q on the mesh when testPoint.DistanceTo(Q) &lt;
//        /// maximumDistance, then set maximumDistance to that value. This parameter is ignored if you
//        /// pass 0.0 for a maximumDistance.
//        /// </param>
...
//        /// <summary>
//        /// Collapses multiple mesh faces, with areas less than LessThanArea and greater than
//        /// GreaterThanArea, based on the principles found in Stan Melax's mesh reduction PDF, see http://pomax.nihongoresources.com/downloads/PolygonReduction.pdf
//        /// </summary>
//        /// <param name="lessThanArea">
//        /// Area in which faces are selected if their area is less than or equal to.
//        /// </param>
//        /// <param name="greaterThanArea">
...
//        /// <remarks>
//        /// This number may differ from the initial number of faces that meet the input criteria
//        /// because the areas of some initial faces may be altered as other faces are collapsed. The
//        /// face area must be both less than LessThanArea AND greater than GreaterThanArea in order
//        /// to be considered. Use large numbers for lessThanArea or zero for greaterThanArea to
//        /// simulate an OR.
//        /// </remarks>
...
//        /// <summary>
//        /// Collapses a multiple mesh faces, determined by face aspect ratio, based on criteria found
//        /// in Stan Melax's polygon reduction, see http://pomax.nihongoresources.com/downloads/PolygonReduction.pdf
//        /// </summary>
...
//        /// <remarks>
//        /// This number may differ from the initial number of faces that meet the input criteria
//        /// because the aspect ratios of some initial faces may be altered as other faces are collapsed.
//        /// </remarks>
...
//        /// <summary>
//        /// Collapses multiple mesh faces, with greater/less than edge length, based on the
//        /// principles found in Stan Melax's mesh reduction PDF, see http://pomax.nihongoresources.com/downloads/PolygonReduction.pdf
//        /// </summary>
//        /// <param name="bGreaterThan">
...
//        /// <remarks>
//        /// This number may differ from the initial number of edges that meet the input criteria
//        /// because the lengths of some initial edges may be altered as other edges are collapsed.
//        /// </remarks>
...
//        /// </summary>
//        /// <param name="corners">
//        /// 8 points defining the box corners arranged as the vN labels indicate. <pre>
...
//        /// <returns>New mesh on success or null on failure.</returns>
...
//        /// Thrown when xCount is less than or equal to zero.
//        /// </exception>
//        /// <exception cref="ArgumentOutOfRangeException">
//        /// Thrown when yCount is less than or equal to zero.
//        /// </exception>
...
//        /// <exception cref="ArgumentOutOfRangeException">
//        /// Thrown when xCount is less than or equal to two.
//        /// </exception>
//        /// <exception cref="ArgumentOutOfRangeException">
//        /// Thrown when yCount is less than or equal to two.
//        /// </exception>
//        /// <returns></returns>
...
//        /// <summary>
//        /// Attempts to create a mesh that is a triangulation of a list of points, projected on a
//        /// plane, including its holes and fixed edges.
//        /// </summary>
//        /// <param name="points">A list, an array or any enumerable of points.</param>
//        /// <param name="plane">A plane.</param>
//        /// <param name="allowNewVertices">
//        /// If true, the mesh might have more vertices than the list of input points, if doing so
//        /// will improve long thin triangles.
//        /// </param>
//        /// <param name="edges">
//        /// A list of polylines, or other lists of points representing edges. This can be null. If
//        /// nested enumerable items are null, they will be discarded.
//        /// </param>
...
//        /// <summary>
//        /// Constructs a icospherical mesh. A mesh icosphere differs from a standard UV mesh sphere
//        /// in that it's vertices are evenly distributed. A mesh icosphere starts from an icosahedron
//        /// (a regular polyhedron with 20 equilateral triangles). It is then refined by splitting
//        /// each triangle into 4 smaller triangles. This splitting can be done several times.
//        /// </summary>
//        /// <param name="sphere">The input sphere provides the orienting plane and radius.</param>
//        /// <param name="subdivisions">
//        /// The number of times you want the faces split, where 0 &lt;= subdivisions &lt;= 7. Note,
//        /// the total number of mesh faces produces is: 20 * (4 ^ subdivisions)
//        /// </param>
...
//        /// (optional: can be null) Outer boundary polyline, if provided this will become the outer
//        /// boundary of the resulting mesh. Any of the input that is completely outside the outer
//        /// boundary will be ignored and have no impact on the result. If any of the input intersects
//        /// the outer boundary the result will be unpredictable and is likely to not include the
//        /// entire outer boundary.
//        /// </param>
//        /// <param name="angleToleranceRadians">
//        /// Maximum angle between unit tangents and adjacent verticies. Used to divide curve inputs
//        /// that cannot otherwise be represented as a polyline.
//        /// </param>
//        /// <param name="innerBoundaryCurves">
//        /// (optional: can be null) Polylines to create holes in the output mesh. If
//        /// innerBoundaryCurves are the only input then the result may be null if trimback is set to
//        /// false (see comments for trimback) because the resulting mesh could be invalid (all faces
//        /// created contained vertexes from the perimeter boundary).
//        /// </param>
//        /// <param name="pullbackSurface">
//        /// (optional: can be null) Initial surface where 3d input will be pulled to make a 2d
//        /// representation used by the function that generates the mesh. Providing a pullbackSurface
//        /// can be helpful when it is similar in shape to the pattern of the input, the pulled 2d
//        /// points will be a better representation of the 3d points. If all of the input is more or
//        /// less coplanar to start with, providing pullbackSurface has no real benefit.
//        /// </param>
//        /// <param name="innerBothSideCurves">
//        /// (optional: can be null) These polylines will create faces on both sides of the edge. If
//        /// there are only input points(innerPoints) there is no way to guarantee a triangulation
//        /// that will create an edge between two particular points. Adding a line, or polyline, to
//        /// innerBothsideCurves that includes points from innerPoints will help guide the triangulation.
//        /// </param>
//        /// <param name="innerPoints">
//        /// (optional: can be null) Points to be used to generate the mesh. If outerBoundary is not
//        /// null, points outside of that boundary after it has been pulled to pullbackSurface (or the
//        /// best plane through the input if pullbackSurface is null) will be ignored.
//        /// </param>
//        /// <param name="trimback">
//        /// Only used when a outerBoundary has not been provided. When that is the case, the function
//        /// uses the perimeter of the surface as the outer boundary instead. If true, any face of the
//        /// resulting triangulated mesh that contains a vertex of the perimeter boundary will be removed.
//        /// </param>
//        /// <param name="divisions">
//        /// Only used when a outerBoundary has not been provided. When that is the case, division
//        /// becomes the number of divisions each side of the surface's perimeter will be divided into
...
//        /// <summary>
//        /// Constructs a quad mesh sphere. A quad mesh sphere differs from a standard UV mesh sphere
//        /// in that it's vertices are evenly distributed. A quad mesh sphere starts from a cube (a
//        /// regular polyhedron with 6 square sides). It is then refined by splitting each quad into 4
//        /// smaller quads. This splitting can be done several times.
//        /// </summary>
//        /// <param name="sphere">The input sphere provides the orienting plane and radius.</param>
//        /// <param name="subdivisions">
//        /// The number of times you want the faces split, where 0 &lt;= subdivisions &lt;= 8. Note,
//        /// the total number of mesh faces produces is: 6 * (4 ^ subdivisions)
//        /// </param>
...
//        /// contained within a closed loop of "unwelded" edges. Unwelded edges are edges where the
//        /// faces that share the edge have unique mesh vertexes (not mesh topology vertexes) at both
//        /// ends of the edge.
//        /// </summary>
//        /// <returns>
//        /// Array of submeshes on success; null on error. If the count in the returned array is 1,
//        /// then nothing happened and the ouput is essentially a copy of the input.
//        /// </returns>
...
//        /// <summary>
//        /// Given a starting "naked" edge index, this function attempts to determine a "hole" by
//        /// chaining additional naked edges together until if returns to the start index. Then it
//        /// triangulates the closed polygon and either adds the faces to the mesh.
//        /// </summary>
...
//        /// <summary>
//        /// Attempts to determine "holes" in the mesh by chaining naked edges together. Then it
//        /// triangulates the closed polygons adds the faces to the mesh.
//        /// </summary>
//        /// <returns>true if successful, false otherwise.</returns>
//        /// <remarks>
//        /// This function does not differentiate between inner and outer naked edges. If you need
//        /// that, it would be better to use Mesh.FillHole.
//        /// </remarks>
...
//        /// <summary>
//        /// Returns all edges of a mesh that are considered "naked" in the sense that the edge only
//        /// has one face.
//        /// </summary>
...
//        /// <summary>
//        /// Attempts to "heal" naked edges in a mesh based on a given distance. First attempts to
//        /// move vertexes to neighboring vertexes that are within that distance away. Then it finds
//        /// edges that have a closest point to the vertex within the distance and splits the edge.
//        /// When it finds one it splits the edge and makes two new edges using that point.
//        /// </summary>
...
//        /// </summary>
//        /// <param name="meshPoint">
//        /// MeshPoint instance contiaining a valid Face Index and Barycentric coordinates.
//        /// </param>
//        /// <returns>
//        /// A Normal vector to the mesh or Vector3d.Unset if the faceIndex is not valid or if the
...
//        /// existing vertex normals. Same as Mesh.Offset(distance, false)
//        /// </summary>
...
//        /// <summary>
//        /// Makes a new mesh with vertices offset a distance in the opposite direction of the
//        /// existing vertex normals. Optionally, based on the value of solidify, adds the input mesh
//        /// and a ribbon of faces along any naked edges. If solidify is false it acts exactly as the
//        /// Offset(distance) function.
//        /// </summary>
...
//        /// Optionally, based on the value of solidify, adds the input mesh and a ribbon of faces
//        /// along any naked edges. If solidify is false it acts exactly as the Offset(distance) function.
//        /// </summary>
//        /// <param name="distance">A distance value.</param>
//        /// <param name="solidify">true if the mesh should be solidified.</param>
...
//        /// </param>
//        /// <returns>
//        /// A Point on the mesh or Point3d.Unset if the faceIndex is not valid or if the barycentric
...
//        /// <summary>
//        /// Evaluates a mesh at a set of barycentric coordinates. Barycentric coordinates must be
//        /// assigned in accordance with the rules as defined by MeshPoint.T.
//        /// </summary>
//        /// <param name="faceIndex">Index of triangle or quad to evaluate.</param>
//        /// <param name="t0">First barycentric coordinate.</param>
//        /// <param name="t1">Second barycentric coordinate.</param>
...
//        /// <summary>
//        /// Removes mesh normals and reconstructs the face and vertex normals based on the
...
//        /// </param>
//        /// <param name="accuracy">
//        /// Integer from 1 to 10 telling how accurate reduction algorithm to use. Greater number
//        /// gives more accurate results
//        /// </param>
//        /// <param name="normalizeSize">
...
//        /// does not modify mesh vertex normals, it rearranges the mesh face winding and face normals
//        /// to make them all consistent. Note, you may want to call Mesh.Normals.ComputeNormals() to
//        /// recompute vertex normals after calling this functions.
//        /// </summary>
...
//        /// </param>
//        /// <returns>
//        /// If countOnly=false, the number of faces that were modified. If countOnly=true, the number
//        /// of faces that would be modified.
//        /// </returns>
...
//        /// <summary>
//        /// Makes sure that faces sharing an edge and having a difference of normal greater than or
//        /// equal to angleToleranceRadians have unique vertexes along that edge, adding vertices if necessary.
//        /// </summary>
//        /// <param name="angleToleranceRadians">Angle at which to make unique vertices.</param>
//        /// <param name="modifyNormals">
//        /// Determines whether new vertex normals will have the same vertex normal as the original
//        /// (false) or vertex normals made from the corrsponding face normals (true)
//        /// </param>
...
//        /// <param name="modifyNormals">
//        /// If true, the vertex normals on each side of the edge take the same value as the face to
//        /// which they belong, giving the mesh a hard edge look. If false, each of the vertex normals
//        /// on either side of the edge is assigned the same value as the original normal that the
//        /// pair is replacing, keeping a smooth look.
//        /// </param>
//        /// <returns>true if successful, false otherwise.</returns>
...
//        /// <summary>
//        /// Makes sure that faces sharing an edge and having a difference of normal greater than or
//        /// equal to angleToleranceRadians share vertexes along that edge, vertex normals are averaged.
//        /// </summary>
...
//        /// Threshold angle (in degrees) which controls whether an edge is softened or not. The angle
//        /// refers to the angles between the adjacent faces of an edge.
//        /// </param>
//        /// <returns>A new mesh with soft edges.</returns>
//        /// <exception cref="InvalidOperationException">
//        /// If displacement failed because of an error. The exception message specifies the error.
//        /// </exception>
...
//        /// <summary>
//        /// Creates a C1 cubic NURBS approximation of a helix or spiral. For a helix, you may have
//        /// radius0 == radius1. For a spiral radius0 == radius0 produces a circle. Zero and negative
//        /// radii are permissible.
//        /// </summary>
...
//        /// Point used only to get a vector that is perpedicular to the axis. In particular, this
//        /// vector must not be (anti)parallel to the axis vector.
//        /// </param>
//        /// <param name="pitch">
//        /// The pitch, where a spiral has a pitch = 0, and pitch &gt; 0 is the distance between the
//        /// helix's "threads".
//        /// </param>
//        /// <param name="turnCount">
//        /// The number of turns in spiral or helix. Positive values produce counter-clockwise
//        /// orientation, negitive values produce clockwise orientation. Note, for a helix, turnCount
//        /// * pitch = length of the helix's axis.
//        /// </param>
...
//        /// </param>
//        /// <param name="pitch">
//        /// The pitch. Positive values produce counter-clockwise orientation, negative values produce
//        /// clockwise orientation.
//        /// </param>
//        /// <param name="turnCount">
//        /// The turn count. If != 0, then the resulting helix will have this many turns. If = 0, then
//        /// pitch must be != 0 and the approximate distance between turns will be set to pitch.
//        /// Positive values produce counter-clockwise orientation, negitive values produce clockwise orientation.
//        /// </param>
//        /// <param name="radius0">
...
//        /// </summary>
//        /// <param name="points">
//        /// The new point locations. The number of points should match the number of point returned
//        /// by NurbsCurve.GrevillePoints().
//        /// </param>
//        /// <returns>true if successful, false otherwise.</returns>
...
//        /// <remarks>To produce the input points, use Surface.CreateCurveOnSurfacePoints.</remarks>
...
//        /// <summary>
//        /// Computes a discrete spline curve on the surface. In other words, computes a sequence of
//        /// points on the surface, each with a corresponding parameter value.
//        /// </summary>
//        /// <param name="surface">
//        /// The surface on which the curve is constructed. The surface should be G1 continuous. If
//        /// the surface is closed in the u or v direction and is G1 at the seam, the function will
//        /// construct point sequences that cross over the seam.
//        /// </param>
//        /// <param name="fixedPoints">
...
//        /// <param name="initCount">
//        /// Maximum number of points to insert beteween fixed points on the first level.
//        /// </param>
//        /// <param name="levels">
//        /// The number of levels (between 1 and 3) to be used in multi-level solver. Use 1 for single
//        /// level solve.
//        /// </param>
//        /// <returns>
//        /// A sequence of surface points, given by surface parameters, if successful. The number of
//        /// output points is approximatelely: 2 ^ (level-1) * initCount * fixedPoints.Count.
//        /// </returns>
//        /// <remarks>To create a curve from the output points, use Surface.CreateCurveOnSurface.</remarks>
...
//        /// <para>
//        /// This is the same as calling <see
//        /// cref="CreateFromCorners(Point3d,Point3d,Point3d,Point3d,double)"/> with tolerance 0.
//        /// </para>
//        /// </summary>
...
//        /// <param name="error">
//        /// If the NurbsSurface could not be created, the error value describes where the failure
//        /// occured. 0 = success, 1 = curve sorter failed, 2 = network initializing failed, 3 =
...
//        // NOTE: If you are using a Rhino 6 based version of Rhino3dmIO, you will get compile errors
//        // due to ArchivableDictionary not implementing ISerializble in V6 // Either update to a V7
//        // version of Rhino3dmIO (check the prerelease box on nuget)
//        // -or- Delete the entire PythonCompute class here. Python functionality is only available
...
//        /// to make a smooth surface. If false, control point locations are not changed or changed
//        /// minimally (only one point may move) and only the knot vector is altered.
//        /// </param>
...
//        /// <param name="uv">
//        /// A point in the parameter space to move from. This location on the surface is moved, and
//        /// the move is smoothly tapered off with increasing distance along the surface from this parameter.
//        /// </param>
//        /// <param name="delta">The direction and magitude, or maximum distance, of the move.</param>
//        /// <param name="uLength">
...
//        /// </summary>
//        /// <param name="edge">Edge to extend. Must be North, South, East, or West.</param>
...
//        /// <summary>
//        /// Gets an estimate of the size of the rectangle that would be created if the 3d surface
//        /// where flattened into a rectangle.
//        /// </summary>
...
//        /// Surface surf = ...; double width, height; if ( surf.GetSurfaceSize( out width, out height
//        /// ) ) { surf.SetDomain( 0, new ON_Interval( 0.0, width ) ); surf.SetDomain( 1, new
//        /// ON_Interval( 0.0, height ) ); }
//        /// </example>
...
//        /// <summary>
//        /// Find parameters of the point on a surface that is locally closest to the testPoint. The
//        /// search for a local close point starts at seed parameters.
//        /// </summary>
//        /// <param name="testPoint">A point to test against.</param>
...
//        /// <param name="tolerance">
//        /// the maximum acceptable 3d distance between from surface(curve_2d(t)) to the locus of
//        /// points on the surface that are closest to curve_3d.
//        /// </param>
...
//        /// <param name="tolerance">
//        /// the maximum acceptable distance from the returned 3d curve to the image of curve_2d on
//        /// the surface.
//        /// </param>
...
//        /// The number of points in the output surface u direction. Must be bigger than uDegree
//        /// (maximum value is 1000)
//        /// </param>
//        /// <param name="vPointCount">
//        /// The number of points in the output surface v direction. Must be bigger than vDegree
//        /// (maximum value is 1000)
//        /// </param>
...
//        /// <summary>
//        /// Rebuilds an existing surface with a new surface to a given point count in either the u or
//        /// v directions independently.
//        /// </summary>
...
//        /// <summary>
//        /// Computes the VolumeMassProperties for a collection of geometric objects. At present only
//        /// Breps, Surfaces, and Meshes are supported.
//        /// </summary>
//        /// <param name="geometry">Objects to include in the area computation.</param>
...
//        /// <summary>
//        /// Intersects a curve with a Brep. This function returns the 3D points of intersection and
//        /// 3D overlap curves. If an error occurs while processing overlap curves, this function will
//        /// return false, but it will still provide partial results.
//        /// </summary>
...
//        /// <param name="tolerance">
//        /// Intersection tolerance. If the curves approach each other to within tolerance, an
...
//        /// <param name="tolerance">
//        /// Intersection tolerance. If the curve approaches itself to within tolerance, an
//        /// intersection is assumed.
//        /// </param>
//        /// <returns>A collection of intersection events.</returns>
...
//        /// <param name="plane">Plane to intersect with.</param>
//        /// <returns>
//        /// An array of polylines describing the intersection loops or null (Nothing in Visual Basic)
...
//        /// </returns>
//        /// <remarks>
//        /// The ray may intersect more than one face in cases where the ray hits the edge between two
//        /// faces or the vertex corner shared by multiple faces.
//        /// </remarks>
...
//        /// <returns>Array of projected points, or null in case of any error or invalid input.</returns>
//        /// <example>
...
//        /// <exception cref="ArgumentOutOfRangeException">
//        /// maxReflections is strictly outside the [1-1000] range.
//        /// </exception>
...
//        /// <summary>
//        /// Gets the interval on curve A where the overlap occurs. If the intersection type is not
//        /// overlap, this value is meaningless.
//        /// </summary>
//        public Interval OverlapA { get; set; }

//        /// <summary>
//        /// Gets the interval on curve B where the overlap occurs. If the intersection type is not
//        /// overlap, this value is meaningless.
//        /// </summary>
//        public Interval OverlapB { get; set; }

//        /// <summary>
//        /// Gets the parameter on Curve A where the intersection occured. If the intersection type is
//        /// overlap, then this will return the start of the overlap region.
//        /// </summary>
//        public double ParameterA { get; set; }

//        /// <summary>
//        /// Gets the parameter on Curve B where the intersection occured. If the intersection type is
//        /// overlap, then this will return the start of the overlap region.
//        /// </summary>
//        public double ParameterB { get; set; }

//        /// <summary>
//        /// Gets the point on Curve A where the intersection occured. If the intersection type is
//        /// overlap, then this will return the start of the overlap region.
//        /// </summary>
//        public Point3d PointA { get; set; }

//        /// <summary>
//        /// Gets the end point of the overlap on Curve A. If the intersection type is not overlap,
//        /// this value is meaningless.
//        /// </summary>
//        public Point3d PointA2 { get; set; }

//        /// <summary>
//        /// Gets the point on Curve B (or Surface B) where the intersection occured. If the
//        /// intersection type is overlap, then this will return the start of the overlap region.
//        /// </summary>
//        public Point3d PointB { get; set; }

//        /// <summary>
//        /// Gets the end point of the overlap on Curve B (or Surface B). If the intersection type is
//        /// not overlap, this value is meaningless.
//        /// </summary>
