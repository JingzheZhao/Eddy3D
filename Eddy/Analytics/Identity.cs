...
namespace Eddy.Analytics
{
    ...
    public static class Identity
    {
        ...
        /// <summary>
        /// Gets an abbreviated machine info string for debugging.
        /// </summary>
        public static string GetMachineInfoAbbreviated()
        {
            try
            {
                string machineName = Environment.MachineName;
                string userName = Environment.UserName;
                string machineAbbrev = machineName.Length > 3 ? machineName.Substring(0, 3) + "..." : machineName;
                string userAbbrev = userName.Length > 3 ? userName.Substring(0, 3) + "..." : userName;
                return $"{machineAbbrev}@{userAbbrev}";
            }
            catch
            {
                return "unknown";
