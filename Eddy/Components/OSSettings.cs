...
//        /// </summary>
//        public OSSettings()
//          : base("OS", "OS", "OSSettings", "Eddy", "Misc")
//        {
//            //dirs.Add(0);
//        }
...
//        {
//            pManager.AddIntegerParameter("Windows Version", "Windows Version", "Windows Version", GH_ParamAccess.list, 1);
//            Param_Integer param = pManager[0] as Param_Integer;
//            param.AddNamedValue("Windows 10", 0);
//            param.AddNamedValue("Windows 8", 1);
//            param.AddNamedValue("Windows 7", 2);
...
//            if (windowsVersionInt == 0)
//            {
//                windowsVersion = "Windows10";
//            }
//            else if( windowsVersionInt == 1)
//            {
...
//            s.WindowsVersion = windowsVersion;
//            s.SaveToFile()
