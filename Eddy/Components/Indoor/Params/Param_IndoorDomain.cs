...
{
    public class IndoorDomaingGoo : GH_Goo<IndoorDomain>, IGH_PreviewData
    {
        #region constructors

        public IndoorDomaingGoo()
        {
            this.Value = new IndoorDomain();
        }

        // constructor with initial value
        public IndoorDomaingGoo(IndoorDomain indomVal)
        {
            this.Value = indomVal;
        }

        // copy constructor
        public IndoorDomaingGoo(IndoorDomaingGoo indom)
        {
        ...
        public override bool Write(GH_IO.Serialization.GH_IWriter writer)
        {
            ...
            writer.SetString("IndoorDomain", json);
        ...
        {
            var json = reader.GetString("IndoorDomain");
            if (!String.IsNullOrWhiteSpace(json))
            {
                this.Value = JsonConvert.DeserializeObject<IndoorDomain>(json);
            }
    ...
    public class Param_IndoorDomain : GH_PersistentParam<IndoorInletGoo>, IGH_PreviewObject
    {
        ...
        public Param_IndoorDomain() :
          base(new GH_InstanceDescription("Domain", "Dom",
              "Domain for indoor simulations", EddyVersion.Name, "7 | Indoor"))
        { }

        // unique id
        public override Guid ComponentGuid
        {
            get { return new Guid("{D72C2A1D-F5A6-4640-A91B-5934C4B82805}"); }
        }
