...
namespace Eddy.Components.Radiation
{
    public class MakeGroundSurface_Component : GH_Component
    {
        ...
        public MakeGroundSurface_Component()
          : base("Ground Surface", "Ground", "Ground Radiation Simulation Surface" + EddyVersion.toString(), EddyVersion.Name, "X | Radiation")
        {
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            {
                var rs = new RSurface("surf", b, thetype, simsim, mat, patchSize);
