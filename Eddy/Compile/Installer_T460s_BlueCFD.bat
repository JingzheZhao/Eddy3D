"C:\Program Files (x86)\Microsoft Visual Studio\2017\Community\MSBuild\15.0\Bin\MSBuild.exe" "C:\Users\Patrick Kastner\Documents\GitHub\WindTunnel\Eddy.sln" -maxcpucount:4
