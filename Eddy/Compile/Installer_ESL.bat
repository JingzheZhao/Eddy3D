"C:\Program Files (x86)\Microsoft Visual Studio\2019\Community\MSBuild\Current\Bin\MSBuild.exe" "C:\Users\pkastner\Documents\GitHub\WindTunnel\Eddy.sln" /p:Configuration=Release
