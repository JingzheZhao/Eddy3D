...
namespace EddyLib
{
    ...
    public static partial class RunFoamSimulation
    {
        ...
        public static void Run(OFBaseDomain domain, OFMeshSettings meshSettings, OFRunSettings runSettings, string workDir)
        {
            ...
            // Remove stale phi files once before writing case files.
            // phi (surfaceScalarField) is generated by potentialFoam / decomposePar and
            // can cause field-type conflicts if left in the 0/ folder when the solver starts.
