...
";
        ...
        public static string CommandLineArgs(string baseWorkingDir, int sensorCnt, string weaname, int ab, int ad,   SkySubdivision diffSky, SkySubdivision dirSky, int n ) {
