...
//                {
//                    iter.Add(double.Parse(str.Split('\t')[0]));
//                    Ux.Add(double.Parse(str.Split('\t')[1]));
//                    Uy.Add(double.Parse(str.Split('\t')[2]));
//                    Uz.Add(double.Parse(str.Split('\t')[3]));
//                    p.Add(double.Parse(str.Split('\t')[4]));
//                    omega.Add(double.Parse(str.Split('\t')[5]));
//                    k.Add(double.Parse(str.Split('\t')[6]));
//                }
//            }

//            parsedResiduals.Add(iter);
//            parsedResiduals.Add(Ux);
//            parsedResiduals.Add(Uy);
//            parsedResiduals.Add(Uz);
